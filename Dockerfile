...
RUN apt-get update && apt-get install clang-3.3 llvm-3.3 llvm-3.3-dev llvm-3.3-runtime libllvm3.3 openssh-server xz-utils  unzip graphviz  git zlib1g.dev build-essential libgmp-dev libtinfo-dev
