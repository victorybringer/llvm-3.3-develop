...
import LLVM.Slicing.Static.SDG.IFDS.Worklist ( worklistFromList )
...
--summFlow (SDGSummEdge vm) Nothing i _ = [Nothing]
...
genSummEdgeMap a g =  -- timeIt2 ("IFDS-SummEdge-ALL") . 
                   extractSummEdges $ runIFDS a g  
